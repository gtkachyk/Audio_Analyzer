...
public class AudioTrackCoordinates extends TrackCoordinates{
    ...
    static final double REMOVE_TRACK_BUTTON_X_COORDINATE = 418.0; // Looks not close enough to side, but need to leave that room for the vertical scroll bar. Original value: 422.0.
